...
// offerValid = confirm("Is the offer still valid?")
// quantityQualifies = prompt("How many items are you buying?")
// productDiscountIsApplied = offerValid &&(premiumMember || quantityQualifies > 2)
